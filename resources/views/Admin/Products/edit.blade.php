...
@section('content')
    ...
    <section class="content">
        ...
        <div class="container-fluid">
            <form action="{{ route('admin.product.update') }}" method="POST" id="productForm" enctype="multipart/form-data">
                @csrf
                <div class="row">
                    <div class="col-md-8">
                        <div class="card mb-3">
                                    ...
                                    <div class="col-md-12">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" name="price" value="{{ $product->price }}"
                                                id="price" class="form-control @error('price')
                                                is-invalid
                                    ...
                                    <div class="col-md-12">
                                        <div class="mb-3">
                                            <div class="custom-control custom-checkbox">
                                                ...
                                                <input class="custom-control-input" type="checkbox" id="track_qty"
                                                    {{ $product->track_qty == 'Yes' ? 'checked' : '' }} name="track_qty"
                                                    value="Yes">
                                        ...
                                        <div class="mb-3">
                                            <input type="number" min="0" name="qty" id="qty"
                                                value="{{ $product->qty }}" class="form-control @error('track_qty')
                                                is-invalid
                                            @enderror" placeholder="Qty">
                                            @error('track_qty')
                                                <span class="text-danger">{{ $message }}</span>
                                            @enderror
                                        </div>
                            ...
                            <div class="card-body">
                                ...
                                <div class="mb-3">
                                    <select name="status" id="status" class="form-control">
                                        <option {{ $product->track_qty == '1' ? 'selected' : '' }} value="1">Active
                                        </option>
                                        <option {{ $product->track_qty == '0' ? 'selected' : '' }} value="0">Block
                                        </option>
                                    </select>
                                </div>
                            </div>
